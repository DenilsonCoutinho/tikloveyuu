        ...
        <div className={` min-h-screen overflow-auto bg-defaultBg bg-contain py-10 flex justify-center items-center`}>
            ...
            <div className='flex flex-col items-center gap-4'>
                <div id="capture" style={{ width: "295px", height: "295px", padding: '20px', backgroundColor: '#f5f5f5' }}>
                    <QRCode value={`https://www.tikloveyuu.com/createSurprise/surpriseView?id=${code}`} />
                </div>
                <div className='flex  md:flex-row flex-col items-center gap-3'>
                    <Button className='text-black px-2 bg-white' onClick={() => captureScreen()}>Baixar QRcode</Button>
                    <Button className='text-black px-2 bg-white' onClick={() => copyToClipboard(`https://www.tikloveyuu.com/createSurprise/surpriseView?id=${code}`)}>Copiar Link</Button>
                    <a href={`https://www.tikloveyuu.com/createSurprise/surpriseView?id=${code}`}>
