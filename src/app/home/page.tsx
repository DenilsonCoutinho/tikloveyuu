...
export default function Presentation() {
    ...
    const [imageCouple, setImageCouple] = useState<[]>([])
            ...
            <div className="flex justify- items-center gap-10">
                <section className="max-w-[800px] w-full">
                    <div>
                        ...
                        <div className="flex flex-col gap-3 ">
                            ...
                            <Input ref={fileInputRef} onChange={handleFileChange} type="file" accept="image/*" multiple className="placeholder:text-white text-white flex justify-center items-center" />
                        </div>
                    </div>
                ...
                <aside>
                    <div className="flex flex-col">
                        ...
                        <Button bg={"slategray"} textColor={'white'} className="border text-white mt-3"> Criar meu site</Button>
                    </div>
                </aside>
            </div>
