...
import ScrollStack from '@/app/components/ScrollStack/ScrollStack'
// import ScrollStack, { ScrollStackItem } from '@/app/components/ScrollStack/ScrollStack'
export default function HowItWorks() {
    ...
    return (
        <>
            <div className='md:my-32 my-10 md:flex hidden lg:flex-row flex-col max-w-[1100px] justify-between m-auto items-center lg:items-start'>
            ...
            <div className="md:hidden flex relative md:flex-row flex-col justify-center lg:items-start items-center lg:justify-between  lg:flex-col  gap-7 ">
                <h1 className='text-white  md:text-5xl text-3xl mb-12 z-50  font-bold'>Como  <span className='text-redDefault'>funciona</span></h1>
                <Image src={heart} alt="heart" className="w-24 lg:relative absolute lg:opacity-100 opacity-10 lg:w-32 object-contain" />
            </div>
...
//                         <div className="p-4 rounded-2xl bg-background/10 backdrop-blur-sm shadow-glow">
//                             {icon}
//                         </div>
//                     </div>
//                 )}
...
//                 {subtitle && (
//                     <p className="text-primary-foreground/80 text-lg mb-4 font-medium tracking-wide uppercase">
//                         {subtitle}
//                     </p>
//                 )}
