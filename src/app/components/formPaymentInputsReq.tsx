    ...
    return (
        <div>
            <div className="flex md:flex-row gap-3 border  border-white max-w-[380px] justify-center rounded-md mt-10 p-1">
                ...
                <button type="button" value={"2"} onClick={() => { setSelectInput(true); setSelectedInput("2") }} className={`payment-1 ${selectInput ? "bg-white  text-black" : "bg-transparent text-white"}    text-md duration-150  font-medium text-center px-3 md:py-0 py-2 md:h-14 rounded-lg`}>
