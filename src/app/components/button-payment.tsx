export default function ButtonPayment({text,disabled,onClick}:any) {
    return (
        <>

            <button disabled={disabled} onClick={onClick} className="button" style={{ "--clr": "#00ad54"} as React.CSSProperties}>
