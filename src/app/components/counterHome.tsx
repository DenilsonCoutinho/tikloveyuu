...
function ContadorEternoHome({ initialDate, initialHour }: CountProps) {
    ...
    return (
        <div>
            ...
            {initialDate && initialHour && <p className='boujee-text font-medium text-center text-[20px]'>
...
export default ContadorEternoHome;
